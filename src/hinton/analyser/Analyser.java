                ...
                
{
  ...
  private Analyser()
  {
    ...
    this.btnPlay.setIcon(
        new ImageIcon(Toolkit.getDefaultToolkit().getImage(
            Analyser.class.getResource("PlayCtrl.gif"))));
  
    this.btnPlay.setDisabledIcon(new ImageIcon(GrayFilter.createDisabledImage(
                 ((ImageIcon)this.btnPlay.getIcon()).getImage())));
    ...
    this.btnStep.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(
            Analyser.class.getResource("StepCtrl.gif"))));
    this.btnStep.setDisabledIcon(new ImageIcon(GrayFilter.createDisabledImage(
                 ((ImageIcon)this.btnStep.getIcon()).getImage())));
    ...
    this.btnPause.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(
            Analyser.class.getResource("PauseCtrl.gif"))));
    this.btnPause.setDisabledIcon(new ImageIcon(GrayFilter.createDisabledImage(
                ((ImageIcon)this.btnPause.getIcon()).getImage())));
  ...
  public String getNeuronName(int neuronID)
  {
    ...
    {
         neuronName = rs.getInputObject(neuronID - 
  ...
  private void computeWindowMenu()
  {
    ...
    {
      this.mnuWindow.add(this.computeWindowMenuItem(
          (JInternalFrame)this.visiblePlotter.get(i)));
    }
  }
  ...
  {
    Plotter plotter = new Plotter("Plot " + this.plotCount,
                                  net);
  ...
  public void setNet(Net net)
  {
    if (net != null)
    {
      ...
      {
        this.stepStatus.setText(Analyser.STATUS_TEXT + this.processedSteps + "/"
            + this.processParameter.cycles());
      } else {
        this.stepStatus.setText(Analyser.STATUS_TEXT + this.processedSteps + "/"
            + 0);
      }
  ...
  {
    MouseEvent newme = SwingUtilities.convertMouseEvent(
                                        me.getComponent(),
                                        me,
    ...
    ComponentRenderer cr = 
                      this.visualNet.getComponentRendererAt(newme.getPoint());
  ...
  private JMenu createPlotMenu(Object plotObj)
  {
    ...
    newPlotter.addActionListener(new ActionListener() {
      ...
      {
        createNewPlotter();
        ((Plotter)visiblePlotter.get(visiblePlotter.size()-1)).
                  addObject(plotObject);
      }
    });
    plot.add(newPlotter);
   ...
   */
  private JMenuItem existingPlotterMenuItem(Object plotObj,
                                            Plotter existingPlotter)
  {
